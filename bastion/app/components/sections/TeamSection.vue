      ...
      <ul class="mt-12 grid grid-cols-1 gap-10 sm:grid-cols-2 lg:grid-cols-5">
        ...
        >
          ...
          >
            ...
            >
              <svg class="size-10 text-white" fill="currentColor" viewBox="0 0 24 24">
...
const teamData = [
  ...
  { name: 'Kichi-Tawa BOURGUINAT', role: 'Business Lead', photo: 'images/team/54n7z3vwzmqd549r.jpg', linkedin: 'www.linkedin.com/in/kitchi-tawa-bourguinat' },
